...
import { RegisterForm } from "../../authentification/register/register.form";
import { FormsType } from "@/types/forms";
import { RegisterContainer } from "../../authentification/register/register.container";
import { ModificationContainer } from "../../authentification/modification/modication.container";
...
const data = authUser
  ...
  <>
      ...
      <div className="mx-aut0 max-w-242.5">
            ...
            <div className="mt-4">
              ...
              <div className="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-2 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                ...
                <Typography component="span" className="font-semibold text-black dark:text-white">
                      <Button variant="ico" icon={{icon: RiArrowDownCircleFill2} }></Button>
